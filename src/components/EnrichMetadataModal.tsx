        ...
        <div className="clear-collection-portal">
          ...
          >
            ...
            <h2 id="enrich-metadata-heading" className="clear-collection-modal__title">
              Enrich all track metadata?
            </h2>

            <p className="clear-collection-modal__lead">
              Fetches BPM, Camelot key, and vibe tags only for tracks missing them — already-enriched
              tracks are skipped, so re-runs stay fast.
            </p>

            <p className="clear-collection-modal__summary tabular-nums">
              <span className="font-medium text-[var(--text)]">{tracksNeeding}</span>
              <span className="text-[var(--text-muted)]"> tracks need metadata</span>
              {releasesNeeding > 0 ? (
                <>
                  <span className="text-[var(--text-muted)]"> · </span>
                  <span className="font-medium text-[var(--text-secondary)]">{releasesNeeding}</span>
            ...
            <p className="clear-collection-modal__lead" style={{ marginTop: '0.75rem' }}>
              Runs in the background while you browse Collection, Insights, or Play. Use the Cancel
              button on the bottom indicator to stop. Import full tracklists first if releases only
              show one track.
            </p>
            ...
            <div className="clear-collection-modal__actions">
              ...
              <button
                ...
                onClick={onConfirm}
                disabled={running || releasesNeeding === 0}
              >
                {running ? (
                  <>
